...
class _RegisterAuthScreenState extends State<RegisterAuthScreen> {
  ...
  Widget registerPage(bool isLargeScreen) {
    return SingleChildScrollView(
      child: ConstrainedBox(
        ...
        child: Container(
          height:
              isLargeScreen ? MediaQuery.of(context).size.height * 0.8 : null,
                          ...
                          textFormField(
                            ...
                            suffixIcon: DropdownButtonHideUnderline(
                              child: DropdownButton<String>(
                                ...
                                items:
                                    emailDomains.map<DropdownMenuItem<String>>(
                                  (String domain) {
              ...
              Container(
                ...
                child: isLargeScreen
                    ? Container(
                        ...
                        child: Center(child: registerPage(isLargeScreen)))
                    : Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(10, 50, 0, 20),
                        child: registerPage(isLargeScreen)),
              ),
            ],
          );
        },
